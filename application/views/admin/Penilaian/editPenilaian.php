                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="table-responsive">
                                ...
                                <form action="<?= base_url('Admin/updatePenilaian/' . $penilaian->id) ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan" class="form-control" cols="5" rows="5"><?= $penilaian->keterangan ?></textarea>
                                    </div>
                                    <a href="<?= base_url('Admin/Penilaian') ?>" class="btn btn-danger">Back</a>
